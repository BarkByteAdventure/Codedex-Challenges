#In a five-star restaurant review system (⭐️⭐️⭐️⭐️⭐️), the stars typically represent the different
...
rating = float(input("How much stars would you like to give the restaurant?"))
